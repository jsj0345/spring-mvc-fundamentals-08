...
public class RequestHeaderServlet extends HttpServlet {
 ...
 private void printStartLine(HttpServletRequest request) {
   ...
   System.out.println("request.isSecure() = " + request.isSecure()); // https인가?
   System.out.println("--- REQUEST-LINE - end ---");
   System.out.println();
 }
 ...
 private void printHeaderUtils(HttpServletRequest request) {
   ...
   System.out.println("request.getServetPort() = " + request.getServerPort()); // Host 헤더
   System.out.println();
...
@WebServlet(name = "requestHeaderServlet", urlPatterns = "/request-header")
public class RequestHeaderServlet extends HttpServlet throws ServletException, IOException {
